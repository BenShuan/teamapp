...
CREATE TABLE `__new_fighters` (
	...
	`class` text,
	`kit` text,
	`current_status` text DEFAULT 'פעיל' NOT NULL,
	`updated_at` text,
...
INSERT INTO `__new_fighters`("id", "id_number", "first_name", "last_name", "email", "personal_number", "address", "phone_number", "shoes_size", "shirt_size", "pants_size", "professional", "team_id", "iron_number", "class", "kit", "current_status", "updated_at", "created_at", "deleted_at") SELECT "id", "id_number", "first_name", "last_name", "email", "personal_number", "address", "phone_number", "shoes_size", "shirt_size", "pants_size", "professional", "team_id", "iron_number", "class", "kit", "current_status", "updated_at", "created_at", "deleted_at" FROM `fighters`;--> statement-breakpoint
